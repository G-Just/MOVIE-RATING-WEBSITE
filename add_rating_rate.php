                ...
                <form action="includes_h/add_rating_rate_h.php" method="POST" id="rate-form">
                    ...
                    <div id="rating-verdict">
                        <div id="verdict-itself-container">
                            <input name='verdict' id='rating-input' type="number" style='display:none'><p id="rating">Scroll to chose</p></input>
                        ...
                        $ratingExists = assocsGetByMoviesIdUsersId($movie['moviesID'], $_SESSION['usersID'], $conn);
                        if ($movie === false){
